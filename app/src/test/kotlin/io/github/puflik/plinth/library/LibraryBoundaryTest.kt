...
class LibraryBoundaryTest {
    ...
    private companion object {
        ...
        val FACADE =
            listOf(
                "library/LibraryRepository.kt",
                "library/LibraryScan.kt",
                "library/FolderSettings.kt",
                "library/UserDataRepository.kt",
                "library/PlaylistRepository.kt",
                "library/PlaylistOrder.kt",
            )
