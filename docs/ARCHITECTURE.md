...
| `core/library` (`plinth-library`) | Модель библиотеки: `Track` → `Version` → `Source`, артисты, альбомы, плейлисты, прослушивания, склейки; дальше — SQLite (B2) | Знать об FFI и Kotlin |
